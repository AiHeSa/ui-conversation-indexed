...
describe('formatters', () => {
  ...
  it('formats cache-hit percentages to two decimals and always rounds down', () => {
    expect(cacheHitPercent({
      uncachedInputTokens: 10, outputTokens: 0, cacheReadTokens: 90, cacheWriteTokens: 0,
    })).toBe('90.00')
    expect(cacheHitPercent({
      uncachedInputTokens: 2, outputTokens: 0, cacheReadTokens: 1, cacheWriteTokens: 0,
    })).toBe('33.33')
    expect(cacheHitPercent({
      uncachedInputTokens: 1, outputTokens: 0, cacheReadTokens: 2, cacheWriteTokens: 0,
    })).toBe('66.66')
  })
})
