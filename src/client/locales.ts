...
export const zh = {
  ...
  'chat.loadOlder': '加载更早',
  'chat.toBottom': '回到底部',
  'chat.index.title': '对话索引',
  'chat.index.shortTitle': '索引',
  'chat.index.hide': '隐藏对话索引',
  'chat.index.hideShort': '隐藏',
  'chat.index.show': '显示对话索引',
  'chat.index.turn': '对话 {turn}',
  ...
  'message.regenerate.dialog': '重新回答原问题',
  'message.regenerate.supplement': '补充提问（可选）',
  'message.regenerate.placeholder': '可留空，直接重新回答原问题',
  'message.regenerate.cancel': '取消',
  'message.regenerate.confirm': '确认并重新提问',
  'message.regenerate.submitting': '正在重新提问…',
  'message.regenerate.failed': '重新提问失败，请重试。',
...
export const en = {
  ...
  'chat.index.title': 'Conversation index',
  'chat.index.shortTitle': 'Index',
  'chat.index.hide': 'Hide conversation index',
  'chat.index.hideShort': 'Hide',
  'chat.index.show': 'Show conversation index',
  'chat.index.turn': 'Conversation {turn}',
  ...
  'message.regenerate.dialog': 'Regenerate the original response',
  'message.regenerate.supplement': 'Additional question (optional)',
  'message.regenerate.placeholder': 'Leave blank to resend the original question',
  'message.regenerate.cancel': 'Cancel',
  'message.regenerate.confirm': 'Confirm and resend',
  'message.regenerate.submitting': 'Resending…',
  'message.regenerate.failed': 'Could not resend the question. Try again.',
