...
// tool-call renderer and its recursive root/subcall composition. On a wide
// enough conversation container, the rendered flow also feeds a sticky turn
// index whose cards include the visible H1-H3 assistant headings.
//
...
import { ConversationIndex } from './ConversationIndex.tsx'
