/**
 * Package-owned invariant companion for `@aihesa/ui-conversation-indexed`.
 * @module @aihesa/ui-conversation-indexed/invariant
 */
...
const PACKAGE_NAME = '@aihesa/ui-conversation-indexed'

/** Cordis companion plugin name. */
export const name = 'client-ui-conversation-indexed-invariant'
